        ...
        <form onSubmit={handleSubmit} className="space-y-4 flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    defaultValue={umkm?.produk_utama_lainnya || ""}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    type="text"
                    name="pembayaran"
                    defaultValue={umkm?.metodePembayaran || ""}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="pengiriman"
                    defaultValue={umkm?.layananPengiriman || ""}
          ...
          {activeTab === "legalitas" && (
            <div className="space-y-3">
              <div>
                <label className="block text-xs font-medium mb-1">
                  Legalitas Usaha (NIB / PIRT / Halal dll)
                </label>
                <input
                  type="text"
