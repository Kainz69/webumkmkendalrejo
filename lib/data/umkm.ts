...
//   // Format snake_case (Supabase Database Columns)
//   nama_umkm?: string;
//   nama_pemilik?: string;
...
//   target_konsumen?: string;
//   link_google_maps?: string;
//   jenis_usaha?: string;
//   produk_utama_lainnya?: string;
//   nama_produk?: string;
...
//   foto_produk?: string;
//   media_promosi?: string;
//   username_link?: string;
//   rekening_usaha?: string;
//   pencatatan_keuangan?: string;
//   metode_pencatatan?: string;
//   legalitas_usaha?: string;
//   informasi_higiene_sanitasi?: string;
// };
export type UMKM = {
  id: string;
  ...
  // ==========================================
  // camelCase (Frontend React/Next.js)
  namaUmkm: string;
  namaPemilik: string;
  alamatLengkap: string;
  nomorHpWa: string;
  ...
  profile_singkat?: string;
  profil_singkat?: string; // alias pengaman
  target_konsumen?: string;
  link_google_maps?: string;
  jenis_usaha?: string;
  jam_operasional?: string;
  ...
  metode_pembayaran?: string | string[];
  pengiriman?: string | string[];
  layanan_pengiriman?: string | string[];
  rekening_usaha?: string;
  media_promosi?: string | string[];
...
export const umkmData: UMKM[] = [
  {
    ...
    alamatLengkap:
      "Jl. Melati No. 12, RT 02/RW 01, Desa Kendalrejo, Kec. Talun, Blitar",
    nomorHpWa: "08123456789",
    tahunBerdiri: 2015,
    profilSingkat:
      "Produksi keripik tempe renyah dengan bumbu khas Jawa Timur, dibuat dari kedelai lokal pilihan tanpa bahan pengawet.",
    targetKonsumen:
      "Ibu rumah tangga, pelajar, wisatawan, dan reseller oleh-oleh",
    ...
    deskripsiProduk:
      "Keripik tempe renyah dibuat dari tempe kedelai segar, digoreng dengan bumbu rahasia turun-temurun. Cocok untuk camilan sehari-hari maupun oleh-oleh khas Kendalrejo.",
    ...
    pencatatanKeuangan: "Ya",
    metodePencatatan: "Buku kas manual & aplikasi BukuWarung",
    legalitasUsaha: ["NIB", "PIRT No. 2123517010001-22"],
    informasiHigieneSanitasi:
      "Produksi di dapur khusus, bahan baku dicuci bersih, pengemas food-grade, tidak menggunakan pewarna buatan.",
  },
  {
    id: "umkm-002",
    ...
    alamatLengkap:
      "Jl. Kenanga No. 5, RT 01/RW 03, Desa Kendalrejo, Kec. Talun, Blitar",
    nomorHpWa: "08234567890",
    tahunBerdiri: 2010,
    profilSingkat:
      "Pengrajin batik tulis motif khas Blitar dengan penggunaan pewarna alam ramah lingkungan, melestarikan budaya lokal Jawa Timur.",
    targetKonsumen:
      "Pecinta batik, instansi pemerintah, wisatawan, dan kolektor seni",
    ...
    deskripsiProduk:
      "Kain batik tulis berkualitas tinggi dengan motif terinspirasi dari Candi Penataran dan alam Blitar. Setiap lembar kain dikerjakan manual oleh pengrajin berpengalaman menggunakan malam dan pewarna alam.",
    harga: "Rp 150.000 – Rp 750.000 / lembar",
    beratUkuran: "2m x 1,15m (kain batik standar)",
    varian: [
      "Motif Candi Penataran",
      "Motif Bunga Kopi",
      "Motif Gunung Kelud",
      "Motif Parang",
    ],
    ...
    fotoProduk:
      "https://images.unsplash.com/photo-1610701596061-2ecf227e85b2?w=600&q=80",
  ...
  },
  {
    ...
    alamatLengkap:
      "Jl. Raya Kendalrejo No. 88, RT 03/RW 02, Desa Kendalrejo, Kec. Talun, Blitar",
    nomorHpWa: "08345678901",
    tahunBerdiri: 2008,
    profilSingkat:
      "Warung soto ayam legendaris dengan kuah bening gurih khas Blitar, sudah berdiri lebih dari 15 tahun dan menjadi favorit warga desa.",
    ...
    deskripsiProduk:
      "Soto ayam kuah bening segar dengan isian ayam kampung, tauge, seledri, dan bawang goreng. Disajikan hangat dengan nasi putih dan kerupuk, rasanya otentik dan mengenyangkan.",
    ...
    informasiHigieneSanitasi:
      "Dapur bersih berstandar Puskesmas, bahan segar dibeli setiap hari dari pasar, air minum dari PDAM, pengelola rutin periksa kesehatan.",
  },
  {
    id: "umkm-004",
    ...
    alamatLengkap:
      "Jl. Mawar No. 3, RT 04/RW 01, Desa Kendalrejo, Kec. Talun, Blitar",
    nomorHpWa: "08456789012",
    tahunBerdiri: 2012,
    profilSingkat:
      "Toko sembako dan kebutuhan pertanian lengkap dengan harga terjangkau, melayani warga desa dan petani sekitar Kendalrejo.",
    ...
    deskripsiProduk:
      "Toko lengkap menyediakan kebutuhan pokok sehari-hari dan sarana produksi pertanian. Melayani pembelian eceran maupun grosir dengan harga bersaing.",
    ...
    layananPengiriman: [
      "Ambil sendiri",
      "Antar gratis (area desa, min. Rp 200.000)",
    ],
  ...
  },
  {
    ...
    alamatLengkap:
      "Jl. Dahlia No. 7, RT 01/RW 04, Desa Kendalrejo, Kec. Talun, Blitar",
    nomorHpWa: "08567890123",
    tahunBerdiri: 2017,
    profilSingkat:
      "Bengkel elektronik dan ponsel terpercaya, melayani servis TV, kipas angin, kulkas, AC, dan ponsel semua merk dengan harga transparan.",
    ...
    deskripsiProduk:
      "Melayani perbaikan ponsel (screen, baterai, software), TV, kulkas, AC, dan peralatan elektronik rumah tangga lainnya. Garansi pengerjaan 1 bulan, harga transparan tanpa biaya tersembunyi.",
    ...
    layananPengiriman: [
      "Ambil & Antar di tempat",
      "Kunjungan rumah (biaya tambahan)",
    ],
    rekeningUsaha: "Mandiri 3344-5566-7788 a.n. Joko Santoso",
    pencatatanKeuangan: "Tidak",
    metodePencatatan: "-",
    legalitasUsaha: ["NIB"],
    informasiHigieneSanitasi: "-",
  },
  {
    ...
    alamatLengkap:
      "Jl. Kopi No. 15, RT 02/RW 04, Desa Kendalrejo, Kec. Talun, Blitar",
    nomorHpWa: "08678901234",
    tahunBerdiri: 2019,
    profilSingkat:
      "Roastery kopi lokal Blitar dengan biji kopi pilihan dari kebun sendiri di lereng Gunung Kelud, menghadirkan cita rasa otentik kopi Jawa.",
    ...
    deskripsiProduk:
      "Kopi robusta dan arabika dari perkebunan lereng Gunung Kelud, dipetik merah, diproses natural, dan di-roast dengan kontrol ketat. Tersedia dalam bentuk biji (whole bean), bubuk, maupun sachet siap seduh.",
    ...
    legalitasUsaha: [
      "NIB",
      "PIRT No. 2143512010002-22",
      "Sertifikat Halal MUI",
    ],
    informasiHigieneSanitasi:
      "Proses roasting di ruang bersih, kemasan vacuum-sealed food-grade, produksi mengikuti SOP higiene pangan.",
  },
  {
    id: "umkm-007",
    ...
    alamatLengkap:
      "Jl. Tani Makmur No. 22, RT 05/RW 02, Desa Kendalrejo, Kec. Talun, Blitar",
    nomorHpWa: "08789012345",
    tahunBerdiri: 2016,
    profilSingkat:
      "Produksi dan distribusi pupuk organik kompos dan bibit tanaman unggul untuk mendukung pertanian berkelanjutan di Desa Kendalrejo dan sekitarnya.",
    ...
    deskripsiProduk:
      "Pupuk organik kompos berkualitas tinggi dari bahan baku kotoran ternak dan limbah pertanian, diolah dengan teknologi fermentasi aerobik. Meningkatkan kesuburan tanah dan hasil panen secara alami.",
    ...
    layananPengiriman: [
      "Ambil sendiri",
      "Antar (area Kec. Talun, min. 5 karung)",
    ],
  ...
  },
  {
    ...
    alamatLengkap:
      "Jl. Anggrek No. 9, RT 03/RW 03, Desa Kendalrejo, Kec. Talun, Blitar",
    nomorHpWa: "08890123456",
    tahunBerdiri: 2020,
    profilSingkat:
      "Salon kecantikan modern di desa yang menyediakan layanan perawatan rambut, kuku, dan kulit dengan tenaga terlatih dan produk berkualitas.",
    targetKonsumen:
      "Wanita desa dan sekitar, persiapan acara pernikahan & wisuda",
    ...
    deskripsiProduk:
      "Layanan salon lengkap meliputi perawatan rambut (potong, smoothing, coloring, creambath), perawatan kuku (manicure & pedicure), dan jasa make up untuk acara spesial. Dikerjakan oleh tenaga terlatih bersertifikat.",
    ...
    layananPengiriman: [
      "Layanan di tempat",
      "Home service (area desa, biaya tambahan)",
    ],
    ...
    informasiHigieneSanitasi:
      "Alat dicuci & disterilkan setiap pemakaian, kursi & area kerja dibersihkan rutin, tersedia hand sanitizer dan masker untuk pelanggan.",
  },
];
...
export function isCurrentlyOpen(umkm: UMKM): boolean {
  ...
  const timeMatch = umkm.jamOperasional.match(
    /(\d{2})\.(\d{2})\s*–\s*(\d{2})\.(\d{2})/,
  );
